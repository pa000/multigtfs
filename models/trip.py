...
if TYPE_CHECKING:
    from app.models import VehicleStopTime
...
class Trip(Base):
    ...
    id: int
    route_id: int
    stoptime_set: Manager["StopTime"]
    vehiclestoptime_set: Manager["VehicleStopTime"]
    triptime: "TripTime"
    ...
    brigade_id = models.IntegerField(null=True, blank=True, db_index=True)
